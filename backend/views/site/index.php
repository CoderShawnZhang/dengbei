    ...
    <div class="container_1">
        <div class="logo"><a href="index.html">灯呗--v1.0</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a href="<?=Url::toRoute('site/login')?>">退出</a></dd>
            </dl>
          </li>
      ...
      <div id="side-nav">
        <ul id="nav">
             <li >
                ...
                <ul class="sub-menu">
                    <li><a _href="<?=Url::toRoute(["Goods/index/index"])?>"><i class="iconfont">&#xe6a7;</i><cite>控制台</cite></a></li >
                </ul>
            </li>
             <li >
                <a href="javascript:;">
                ...
                <ul class="sub-menu">
                    <li><a _href="<?=Url::toRoute(["Goods/index/test"])?>"><i class="iconfont">&#xe6a7;</i><cite>图标字体</cite></a></li>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='<?=Url::toRoute(["welcome"])?>' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
        </div>
    </div>
